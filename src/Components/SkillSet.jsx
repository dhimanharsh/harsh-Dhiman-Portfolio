...
<div className="flex flex-col justify-between h-full bg-slate-950">
  {/* Top Heading */}
  <div className="m-auto flex flex-col justify-center items-center text-white text-center px-4">
  ...
  <div className="grid h-auto md:h-[30rem] grid-cols-1 sm:grid-cols-2 md:grid-cols-3 grid-rows-none md:grid-rows-4 gap-4 w-[95%] m-auto px-4">
    ...
    <section className="col-start-1 col-end-2 md:row-start-1 md:row-end-4 rounded-2xl flex justify-center">
      <img src="/harshdhimanpic.jpg" className="h-full rounded-3xl object-cover" />
    </section>

    {/* Experience Card */}
    <section className="text-white col-start-1 sm:col-start-2 md:col-start-2 col-end-2 md:col-end-3 row-start-auto md:row-start-2 md:row-end-4 rounded-2xl flex flex-col justify-center items-center border-4 p-4 text-center">
    ...
    {/* Education Card */}
    <section className="text-white col-start-1 sm:col-start-1 md:col-start-3 col-end-2 md:col-end-4 row-start-auto md:row-start-2 md:row-end-4 rounded-2xl flex flex-col justify-center items-center border-4 p-4 text-center">
    ...
    {/* About Paragraph */}
    <section className="text-white flex justify-center items-center border-4 md:row-start-4 md:col-start-2 md:col-end-4 rounded-2xl col-span-full p-4 text-center text-base sm:text-lg leading-relaxed overflow-hidden break-words">
  <p className="">
